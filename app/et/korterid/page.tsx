...
const apartments = [
  {
    ...
    rooms: "2 tuba",
    description:
      "Esimese korruse korter avaneb privaatsele hoovialale. Kõrged laed, algupärased restaureeritud puitpõrandad ja suur rõdu loovad eraldatuse tunde kesklinna läheduses.",
    features: [
      "Kõrged laed (3,1 m)",
  ...
  },
  {
    ...
    features: [
      "Kõrged laed (3,3 m)",
      "Lahuslahti elutuba",
      "Kolm eraldatud magamistuba",
      "Vana ornamenteeritud trepikoda",
      "Parkimine hoovis",
    ],
    imageSrc: "/images/apartment-living.jpeg",
    imageAlt: "Korter 3 elutuba",
  },
  {
    id: "apt-3",
    number: "Korter 5",
        ...
        <div className="max-w-screen-xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-stone-800/30">
            {[
              ...
              { num: "65–145 m²", label: "Pindade vahemik" },
              { num: "1–4", label: "Tubade valik" },
            ].map((stat) => (
