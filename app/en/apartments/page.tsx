...
const apartments = [
  {
    id: "apt-1",
    number: "Apartment 1",
    title: "Courtyard residence — quiet and private",
    area: "68 m²",
    floor: "Ground floor",
    rooms: "2 rooms",
    description:
      "A ground-floor apartment opening onto the private courtyard. High ceilings, restored original timber floors and a generous terrace create a sense of seclusion close to the city centre.",
    features: [
      "High ceilings (3.1 m)",
  ...
  },
  {
    ...
    features: [
      ...
      "Ornamental period stairwell",
      "Courtyard parking",
    ],
    imageSrc: "/images/apartment-living.jpeg",
    imageAlt: "Apartment 3 living room",
  },
  {
    id: "apt-5",
    number: "Apartment 5",
    title: "Family residence — with terrace and garden",
    area: "138 m²",
    floor: "Third floor",
    rooms: "4 rooms",
    description:
        ...
        <div className="max-w-screen-xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-stone-800/30">
            {[
              ...
              { num: "65–145 m²", label: "Range of sizes" },
              { num: "1–4", label: "Rooms available" },
            ].map((stat) => (
