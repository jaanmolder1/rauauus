...
export const metadata: Metadata = {
  title: "Contact — Raua 22 | Kadriorg, Tallinn",
  description:
    "Contact the Raua 22 team. We arrange private viewings of our exclusive residences in Kadriorg's heritage building at a time that suits you.",
  openGraph: {
