...
export const metadata: Metadata = {
  title: "Overview — Raua 22 | Kadriorg, Tallinn",
  description:
    "An introduction to Raua 22 — a protected heritage building at the heart of Kadriorg. Five exceptional residences where history and contemporary comfort meet.",
  openGraph: {
    title: "Overview — Raua 22",
    description:
      "A protected heritage building at the heart of Kadriorg. Five exceptional residences.",
    locale: "en_GB",
  },
};
...
export default function OverviewPage() {
  return (
    <>
      <HeroSection
        eyebrow="Overview"
        title="Kadriorg. History. Made to live in."
        ...
        <div className="max-w-screen-xl mx-auto px-6 lg:px-12">
          <div className="max-w-3xl">
            ...
            <p className="font-sans font-light text-stone-400 leading-[1.85] text-sm lg:text-base">
              A listed building in Kadriorg's historic quarter is a testament to enduring value. Architectural character, locational prestige and careful restoration combine to create a living environment that does not age.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-screen-xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            <div>
              ...
              >
                The heart of Kadriorg — Tallinn's most prestigious address
              </h2>
              <div className="space-y-5 mb-10">
                <p className="font-sans font-light text-stone-500 leading-[1.85] text-sm lg:text-base">
                  Raua Street occupies the central part of Kadriorg's residential quarter — just past the museum belt, where the noise of the city gives way to a quiet that feels deliberate. The street is lined with historic trees and the distinguished buildings characteristic of the neighbourhood.
                </p>
                <p className="font-sans font-light text-stone-500 leading-[1.85] text-sm lg:text-base">
            ...
            <div className="relative aspect-[4/5] overflow-hidden">
              <Image
                ...
                alt="Kadriorg park and surroundings"
                fill
